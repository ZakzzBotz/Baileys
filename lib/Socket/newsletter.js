    ...
    return {
        ...
        newsletterFetchAllParticipating: async () => {
            ...
            for (const item of newsletters) {
                ...
                if (!id || !(0, WABinary_1.isJidNewsletter)(id)) {
                    continue;
                }
                ...
                const meta = {
                    ...
                    handle: tm?.handle,
                    picture: (0, Utils_1.getUrlFromDirectPath)(tm?.picture?.direct_path || ''),
                    preview: (0, Utils_1.getUrlFromDirectPath)(tm?.preview?.direct_path || ''),
